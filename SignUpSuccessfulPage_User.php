        ...
        <div class="row">
            ...
            <div class="col d-flex justify-content-center align-items-center" style="padding: 6px 12px;margin-top: 20%;margin-bottom: 0px;">
                <div class="card" style="background: rgba(255,255,255,0);width: 80%;height: 100%;border-radius: 20px;border-width: 0px;padding: 6px 12px;box-shadow: 0px 3px 5px 1px rgba(33,37,41,0.18);">
                    ...
                    <div class="col" id="signupbtn" style="text-align: center;padding: 6px 12px;"><a class="btn btn-primary" role="button" style="color: rgb(255,255,255);font-weight: bold;font-size: 12px;background: rgb(247,73,73);border-width: 0px;padding: 6px 12px;width: 50%;height: 100%;border-radius: 20px;" href="LoginPage_User.php">LOGIN</a></div>
                </div>
            </div>
        </div>
    </div>
