    ...
    <div class="container" id="main" style="margin: 0px 0px;margin-bottom: 10%;margin-right: 0px;margin-left: 0px;padding: 0px 0px;max-width: 100%;">
        <div class="row d-block" style="margin: 0px 0px;">
            ...
            <div class="col d-flex justify-content-center align-items-center" style="padding: 6px 12px;margin-top: 10%;">
                <div class="card" style="background: rgba(255,255,255,0);width: 80%;height: 100%;border-radius: 20px;border-width: 0px;padding: 6px 12px;box-shadow: 0px 0px 20px 1px rgba(33,37,41,0.59);">
                    <div class="card-body" style="padding: 6px 12px;">
                        ...
                        <form style="padding: 6px 12px;"><label class="form-label" style="color: rgb(0,0,0);font-weight: bold;">Confirm Password</label><input class="form-control" type="password" placeholder="Password" style="border-radius: 0px;box-shadow: 0px 3px 5px 1px rgba(33,37,41,0.18);border-width: 0px;"></form>
                    </div>
                    <div class="col" id="alreadyhaveanaccountbtn" style="text-align: right;padding: 6px 12px;"><a class="btn btn-primary" role="button" style="color: rgb(0,0,0);font-weight: bold;font-size: 14px;background: rgba(255,255,255,0);border-width: 0px;padding: 0px 12px;" href="LoginPage_User.php">Already have an account?&nbsp;<i class="fas fa-arrow-right"></i></a></div>
                    <div class="col" id="signupbtn" style="text-align: center;padding: 6px 12px;"><a class="btn btn-primary" role="button" style="color: rgb(255,255,255);font-weight: bold;font-size: 12px;background: rgb(247,73,73);border-width: 0px;padding: 6px 12px;width: 50%;height: 100%;border-radius: 20px;" href="SignUpSuccessfulPage_User.php">SIGN UP</a></div>
                </div>
            </div>
        </div>
    </div>
