...
<body class="d-flex flex-column" style="min-height: 100vh;">
    ...
    <div class="container" id="main" style="max-width: 900px;">
        ...
        <form class="mx-auto justify-content-xxl-center changePasswordForm" style="max-width: 500px;" novalidate="">
            ...
            <div class="row">
                <div class="col d-flex justify-content-center"><a class="btn btn-primary" role="button" style="border-radius: 25px;padding-right: 30px;padding-left: 30px;" href="LoginPage_User.php">Confirm</a></div>
            </div>
        </form>
    </div>
    <!-- Footer -->
