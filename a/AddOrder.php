                ...
                <div class="container-fluid" style="padding: 0px 5%;background: rgba(221,221,221,0);margin: 0px;border-radius: 10px;">
                    <div class="row">
                        ...
                        <div class="col" style="text-align: right;">
                            ...
                            </div><a class="btn btn-primary" role="button" style="margin-left: 15px;background: rgb(255,255,255);color: rgb(50,203,37);border-width: 2px;border-color: rgb(50,203,37);" href="AdminOrder.php"><strong>Add Order</strong></a>
                        </div>
                    </div>
