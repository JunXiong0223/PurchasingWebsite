...
document.getElementById('BMdropdownSearchInput').addEventListener('keyup', BMfilterfirstBMDropdown);
...
function BMfilterfirstBMDropdown() {
          let input = document.getElementById('BMdropdownSearchInput');
...
function filterBMDropdown(counter) {
    let input = document.getElementById(`BMdropdownSearchInput${counter}`);
    let filter = input.value.toUpperCase();
    let dropdownMenu = input.closest('.dropdown-menu');
