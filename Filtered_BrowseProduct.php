...
<body class="flex-column" style="min-height: 100vh;">
    ...
    <div class="container" id="main" style="display: flex;min-height: 100vh;margin-bottom: 20px;">
        <div class="row">
            <div class="col-1 text-center" style="padding: 0px;width: 65px;"><a class="btn btn-primary" role="button" style="color: rgb(0,0,0);background: rgba(255,255,255,0);padding: 6px 12px;border-width: 0px;" href="BrowseProduct.php"><i class="fas fa-arrow-left"></i></a></div>
            <div class="col-6" style="padding: 6px 12px;">
                <h5>All Products &gt;&gt; Car Model A</h5>
            </div>
